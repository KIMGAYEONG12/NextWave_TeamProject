      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_320px] gap-5 mb-5">
        <Card>
          ...
          <p className="text-xs text-ink-500 mb-4">
            매출 분석, 예약 관리, 멤버십, 마케팅 기능까지 모든 기능을 이용할 수
            있는 요금제입니다.
          </p>
          <ul className="space-y-2 text-sm text-ink-600 mb-5">
            {[
              ...
              <li key={f} className="flex items-center gap-2">
                <Icon name="check" className="w-3.5 h-3.5 text-brand-500" /> {f}
              </li>
            ))}
          </ul>
        ...
        <Card>
          ...
          <dl className="space-y-3 text-sm mb-4">
            <div className="flex justify-between">
              <dt className="text-ink-500">결제 주기</dt>
              <dd className="text-ink-800">매월 결제</dd>
            </div>
            <div className="flex justify-between">
              <dt className="text-ink-500">다음 결제일</dt>
              <dd className="text-ink-800">2026.09.07 (월)</dd>
            </div>
            <div className="flex justify-between">
          ...
          <div className="flex items-center justify-between rounded-lg border border-ink-100 px-3 py-2.5 mb-3">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs bg-ink-100 rounded px-1.5 py-0.5">
                카드
              </span>
              <span className="text-sm text-ink-800">···· 1234</span>
              <button className="text-xs text-brand-600 font-medium">
                변경
              </button>
            </div>
          </div>
          ...
          <h4 className="text-sm font-semibold text-ink-800 mt-5 mb-3">
            이용량 현황 (이번 달)
          </h4>
          {[
            ...
            {pricingPlans.map((p) => (
              ...
              >
                ...
                <p className="text-base font-bold text-ink-900 mb-2">
                  {p.price}
                  <span className="text-xs text-ink-400 font-normal">/월</span>
                </p>
